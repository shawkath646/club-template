                ...
                <div>
                    <div className="py-6 px-4 bg-blue-100 dark:bg-gray-800 rounded-lg shadow-md mt-10 max-w-md">
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col md:flex-row items-center gap-3">
                            <InputField fieldId="docId" label="Enter Document ID" {...register("docId", { required: { value: true, message: "Document ID not provided!" }, minLength: { value: 7, message: "Minimum 7 characters is required!" }, maxLength: { value: 15, message: "Maximum 15 characters is allowed!" } })} placeholder="e.g., 123456789" />
