...
export default function Navbar({ session }: { session: Session | null }) {
    ...
    return (
        <nav className={`fixed print:static top-0 left-0 z-[99] w-full transition-colors duration-300 ${hasScrolled ? 'bg-gradient-to-r from-sky-600 to-blue-700' : 'bg-transparent pt-8'}`}>
